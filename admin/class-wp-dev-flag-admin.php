...
class Wp_Dev_Flag_Admin {
	...
	public function enqueue_scripts() {
		...
		$show_flag       = [ 'show_flag' => get_option( 'wp_dev_flag_show_flag', null )	 ];
		$trigger_options = get_option( 'wp_dev_flag_trigger_options', [] );
        $display_options = get_option( 'wp_dev_flag_display_options', [] );
		$link_options    = get_option( 'wp_dev_flag_link_options', [] );
		...
		wp_localize_script( $this->plugin_name, 'wp_dev_flag_options', array_merge( $show_flag, $trigger_options, $display_options, $link_options ) );
